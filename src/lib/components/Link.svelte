...
<div class="flex flex-col items-center w-72 sm:w-[30rem] md:w-[48rem] group">
	...
	<p class="mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-100 text-gray-600">{link.description}</p>
</div>