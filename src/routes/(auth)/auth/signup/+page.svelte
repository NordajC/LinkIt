...
>
	...
	<button class="form-button bg-[#333] text-white rounded-lg p-2"> Sign Up </button>
	<p>Already have an account? <a class="underline" href="/auth/login"><strong>Log In</strong></a></p>
